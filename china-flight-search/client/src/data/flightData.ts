...
const latestQuery: QueryResult = {
  ...
  queryDateLabel: "2026年2月22日 11:36 PST",
  isLatest: true,
  searchParams: {
    origin: "西雅图（SEA）",
    departWindow: "2026年6月20日 – 8月1日",
  ...
  shanghaiResults: {
    ...
    flightNumber: "DL 281 / DL 282",
    departureTimes: [
      "Jun 20", "Jun 27", "Jul 4", "Jul 11", "Jul 18", "Jul 25", "Aug 1",
    ],
    returnTimes: [
      "Aug 20",
    ],
